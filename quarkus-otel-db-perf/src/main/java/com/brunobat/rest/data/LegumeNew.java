...
public class LegumeNew {
    ...
    public static LegumeNewBuilder builder() {
        return new LegumeNewBuilder();
    }
    ...
    public String toString() {
        return "LegumeNew(name=" + this.getName() + ", description=" + this.getDescription() + ")";
    }
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof LegumeNew;
    }
    ...
    public static class LegumeNewBuilder {
        ...
        public LegumeNew build() {
            return new LegumeNew(this.name, this.description);
        }

        public String toString() {
            return "LegumeNew.LegumeNewBuilder(name=" + this.name + ", description=" + this.description + ")";
        }
    }
}
